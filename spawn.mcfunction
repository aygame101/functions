...
#Attribution de l'ID
  ...
  #Le premier message est pour tous les "anciens" joueurs, alors que le second est pour le nouveau
    ...
    execute as @a unless score @s ID matches 1.. run tellraw @s [{"text":"§7§lServeur§r §8➤ "},{"text":"Bienvenue à ","color":"green"},{"selector":"@s"},{"text":" sur Aycraft !","color":"green"}]
  #Attribution d'un ID
